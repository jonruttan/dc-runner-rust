...
- `specs/04_governance/metrics/objective_manifest.yaml`
...
- `specs/04_governance/metrics/baseline_update_notes.yaml`
...
version: 1
entries:
- baseline: specs/04_governance/metrics/objective_scorecard_baseline.json
  sha256: <64 hex chars>
  rationale: <non-empty>
